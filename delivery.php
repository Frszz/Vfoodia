                ...
                <section class="container section section__height">
                    <form class="form-data" method="POST" action="<?= base_url() ?>/process/create.php"
                        ...
                        <div class="form-input">
                            <label>Kode</label>
                            <input type="text" name="code" maxlength="100" value="Generate By System" placeholder="Kode"
                                oninput="this.value = this.value.replace(/[^a-zA-Z0-9]/g, '')" readonly required>
                        </div>
                        <div class="form-input">
                        ...
                        <div class="form-input">
                            <label>Qty/Box</label>
                            <input type="text" name="qty_box" placeholder="Qty/Box"
                        ...
                        <div class="form-input">
                            <button type="submit" class="submit" name="create-delivery"><i class='bx bx-save'></i>
                                Create</button>
                        </div>
                    </form>
                </section>
                ...
                <main>
                    <section class="container section section__height">
                        <form class="form-data" method="POST" action="<?= base_url() ?>/process/update.php"
                            ...
                            <div class="form-input">
                                <label>Kode</label>
                                <input type="text" name="code" maxlength="100" value="<?= $dataDelivery['code'] ?>"
                                    placeholder="Kode" oninput="this.value = this.value.replace(/[^a-zA-Z0-9]/g, '')" readonly
                                    required>
                            </div>
                            <div class="form-input">
                                <label>Penjualan</label>
                            ...
                            <div class="form-input">
                                <label>Qty/Box</label>
                                <input type="text" name="qty_box" value="<?= $dataDelivery['qty_box'] ?>" placeholder="Qty/Box"
                                    oninput="this.value = this.value.replace(/[^0-9]/g, '')" required>
                            </div>
                            <div class="form-input">
                                <label>Jadwal</label>
                            ...
                            <div class="form-input">
                                <label>Status</label>
                                <input type="text" name="status" maxlength="20" value="<?= $dataDelivery['status'] ?>"
                                    placeholder="Status" oninput="this.value = this.value.replace(/[^a-zA-Z]/g, '')" disabled>
                            </div>
                            <div class="form-input">
                                <button type="submit" class="submit" name="update-delivery"><i class='bx bx-edit'></i>
                                    Update</button>
                            </div>
                        </form>
                    </section>
                        ...
                        <section class="container section section__height">
                            <form class="form-data" method="POST" action="<?= base_url() ?>/process/delete.php"
                                ...
                                <div class="form-input">
                                    <label>Kode</label>
                                    <input type="text" name="code" maxlength="100" value="<?= $dataDelivery['code'] ?>"
                                        placeholder="Kode" oninput="this.value = this.value.replace(/[^a-zA-Z0-9]/g, '')" disabled>
                                </div>
                                <div class="form-input">
                                    <label>Penjualan</label>
                                    <input type="text" name="sales" maxlength="100"
                                        value="<?= $dataDelivery['sales_code'] ?> - <?= $dataDelivery['customer_code'] ?>(<?= $dataDelivery['customer_name'] ?>)"
                                        placeholder="Sales" oninput="this.value = this.value.replace(/[^a-zA-Z0-9()- ]/g, '')" disabled>
                                </div>
                                <div class="form-input">
                                    <label>Kurir</label>
                                    <input type="text" name="kurir" maxlength="100"
                                        value="<?= $dataDelivery['kurir_code'] ?> - <?= $dataDelivery['kurir_name'] ?>"
                                        placeholder="Kurir" oninput="this.value = this.value.replace(/[^a-zA-Z0-9()- ]/g, '')" disabled>
                                </div>
                                <div class="form-input">
                                    <label>Qty/Box</label>
                                    <input type="text" name="qty_box" value="<?= $dataDelivery['qty_box'] ?>" placeholder="Qty/Box"
                                ...
                                <div class="form-input">
                                    <button type="submit" class="submit" name="delete-delivery"><i class='bx bx-trash'></i>
                                        Delete</button>
                                </div>
                            </form>
                        </section>
                        ...
                        <?php endif; ?>
                                    ...
                                    <table id="record" class="display nowrap" style="width:100%">
                                        <thead>
                                            ...
                                            <tr>
                                                <th><input type="text" style="width: 100px; height: 18px;" class="search-field"
                                                        placeholder="Cari Kode"></th>
                                                <th><input type="text" style="width: 150px; height: 18px;" class="search-field"
                                                        placeholder="Cari Kode Penjualan"></th>
                                                <th><input type="text" style="width: 150px; height: 18px;" class="search-field"
                                                        placeholder="Cari Kode Pelanggan"></th>
                                                <th><input type="text" style="width: 150px; height: 18px;" class="search-field"
                                                        placeholder="Cari Nama Pelanggan"></th>
                                                <th><input type="text" style="width: 150px; height: 18px;" class="search-field"
                                                        placeholder="Cari No. Hp Pelanggan"></th>
                                                <th><input type="text" style="width: 150px; height: 18px;" class="search-field"
                                                        placeholder="Cari Alamat Pelanggan"></th>
                                                <th><input type="text" style="width: 120px; height: 18px;" class="search-field"
                                                        placeholder="Cari Kode Kurir"></th>
                                                <th><input type="text" style="width: 120px; height: 18px;" class="search-field"
                                                        placeholder="Cari Nama Kurir"></th>
                                                <th><input type="text" style="width: 150px; height: 18px;" class="search-field"
                                                        placeholder="Cari No. Hp Kurir"></th>
                                                <th><input type="text" style="width: 150px; height: 18px;" class="search-field"
                                                        placeholder="Cari No. Plat Kendaraan"></th>
                                                <th><input type="text" style="width: 160px; height: 18px;" class="search-field"
                                                        placeholder="Cari Jadwal Pengantaran"></th>
                                                <th></th>
                                                <th></th>
                                                <th></th>
                                            </tr>
                                        ...
                                        $(window).on('load', function () {
                                            new DataTable('#record', {
                                                ...
                                                rowCallback: function (row, data, index) {
                                                    ...
                                                    $(row).removeClass('status-wait status-wa status-otw status-done status-cancel');
                                                    ...
                                                    if (className) {
                                                        ...
                                                        fixedLeftRow.removeClass('status-wait status-wa status-otw status-done status-cancel').addClass(className);
                                                        fixedRightRow.removeClass('status-wait status-wa status-otw status-done status-cancel').addClass(className);
                                                    }
                                                },
                        ...
                        if (!empty($listLocation)) {
                                ...
                                ?>
                                        <table class="detail-dlv">
                                            ...
                                            <tr>
                                                ...
                                                <td class="key">Menunggu Kurir</td>
                                            </tr>
                                            <tr>
                                                <td class="val">
                                                    <div class="color-box" style="background-color: yellow;"></div>
                                                </td>
                                                <td class="key">Kurir Dalam Perjalanan</td>
                                            </tr>
                                            <tr>
                                                <td class="val">
                                                    <div class="color-box" style="background-color: green;"></div>
                                                </td>
                                                <td class="key">Pengantaran Selesai</td>
                                            </tr>
                                            <tr>
                                                <td class="val">
                                                    <div class="color-box" style="background-color: red;"></div>
                                                </td>
                                                <td class="key">Pengantaran dibatalkan</td>
                                            </tr>
                                        </table>
                            <?php
                            }
                            ?>
                                    ...
                                    <div id="map" style="position: relative;">
                                        ...
                                        <button id="toggleRouteInfo"
                                            style="display: none; position: absolute; top: 10px; right: 10px; z-index: 999; background: #4285F4; color: white; border: 1px solid #3367D6; padding: 8px 16px; cursor: pointer; font-weight: 500; font-size: 13px;">
                                            Lihat Rute
                                        </button>
                                    </div>
                                    <table class="detail-dlv" id="delivery-details">
                                        ...
                                        <tr id="route-info-row" style="display: none;">
                                            <td colspan="4"
                                                style="background-color: #e3f2fd; padding: 10px; font-weight: bold; text-align: center;"
                                                id="route-summary">
                                ...
                                foreach ($listLocation as $index => $itemLocation) {
                                    ?>
                                            <tr class="delivery-row" data-lat="<?= $itemLocation['lat'] ?>" data-lng="<?= $itemLocation['lng'] ?>">
                                                ...
                                                <td class="val" style="width: fit-content; white-space: nowrap;"><a
                                                        href="https://www.google.com/maps?q=<?= $itemLocation['lat'] ?>,<?= $itemLocation['lng'] ?>"
                        ...
                        ?>
                                    <script>
                                        ...
                                        async function drawRoutes(startLat, startLng) {
                                            ...
                                            // Add start location marker if custom route is active
                                            if (customRouteActive && tujuanWithDistance.length > 0) {
                                                const startIcon = L.divIcon({
                                                    className: 'custom-marker-start',
                                                    html: `<div style="background-color: #34A853; color: white; border-radius: 50%; width: 36px; height: 36px; display: flex; align-items: center; justify-content: center; font-weight: bold; border: 3px solid white; box-shadow: 0 2px 8px rgba(0,0,0,0.4); font-size: 18px;">A</div>`,
                                                    iconSize: [36, 36],
                                                    iconAnchor: [18, 18]
                                                });

                                                const startMarker = L.marker([startLat, startLng], { icon: startIcon }).addTo(Omap);
                                                startMarker.bindPopup(`
                                            <b>Lokasi Awal (A)</b><br>
                                            Titik mulai perjalanan
                                        `);
                                                destinationMarkers[`start_${startLat},${startLng}`] = startMarker;
                                            }

                                            tujuanWithDistance.forEach((dest, index) => {
                                                const isEndPoint = customRouteActive && index === tujuanWithDistance.length - 1;

                                                const customIcon = L.divIcon({
                                                    className: isEndPoint ? 'custom-marker-end' : 'custom-marker',
                                                    html: isEndPoint
                                                        ? `<div style="background-color: #EA4335; color: white; border-radius: 50%; width: 36px; height: 36px; display: flex; align-items: center; justify-content: center; font-weight: bold; border: 3px solid white; box-shadow: 0 2px 8px rgba(0,0,0,0.4); font-size: 18px;">B</div>`
                                                        : `<div style="background-color: #4285F4; color: white; border-radius: 50%; width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; font-weight: bold; border: 2px solid white; box-shadow: 0 2px 5px rgba(0,0,0,0.3);">${dest.sequence}</div>`,
                                                    iconSize: isEndPoint ? [36, 36] : [32, 32],
                                                    iconAnchor: isEndPoint ? [18, 18] : [16, 16]
                                                });

                                                const marker = L.marker([dest.lat, dest.lng], { icon: customIcon }).addTo(Omap);
                                                const popupContent = isEndPoint
                                                    ? `<b>Lokasi Tujuan (B)</b><br>${dest.label}<br>Distance from start: ${dest.distanceFromPrev.toFixed(2)} km<br>${dest.address || ''}`
                                                    : `<b>Stop ${dest.sequence}: ${dest.label}</b><br>Distance from previous: ${dest.distanceFromPrev.toFixed(2)} km<br>${dest.address || ''}`;
                        ...
                        <script>
                            ...
                            $(document).on('click', '#btnCariRute', function () {
                                ...
                                $('#nearestLocationText').html(
                                    `<strong>${startName}</strong> → <strong>${endName}</strong> (Rute Langsung)`
                                );
                                ...
                                Swal.fire({
                                    ...
                                    html: `Menampilkan rute langsung dari <strong>${startName}</strong> ke <strong>${endName}</strong>`,
                                    timer: 2000,
